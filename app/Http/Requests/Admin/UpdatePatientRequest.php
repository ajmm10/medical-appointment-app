...
class UpdatePatientRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'chronic_conditions.max' => 'Las enfermedades crónicas no pueden superar los 500 caracteres.',
            'surgical_history.max' => 'Los antecedentes quirúrgicos no pueden superar los 500 caracteres.',
            'family_history.max' => 'Los antecedentes familiares no pueden superar los 500 caracteres.',
